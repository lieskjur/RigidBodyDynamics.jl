...
@propagate_inbounds function bias_acceleration(jt::Involute, frame_after::CartesianFrame3D, frame_before::CartesianFrame3D,
        q::AbstractVector, v::AbstractVector)
...
@propagate_inbounds function joint_torque!(τ::AbstractVector, jt::Involute, q::AbstractVector, joint_wrench::Wrench)
...
@inline function motion_subspace(jt::Involute, frame_after::CartesianFrame3D, frame_before::CartesianFrame3D,
        q::AbstractVector)
...
@inline function constraint_wrench_subspace(jt::Involute, joint_transform::Transform3D)
